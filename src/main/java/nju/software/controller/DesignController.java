...
public class DesignController {
	...
	public String verifyDesignSubmit(HttpServletRequest request,
		...
		Account account = (Account) request.getSession().getAttribute(
				"cur_user");
		boolean designVal = Boolean.parseBoolean(request
				.getParameter("designVal"));
		...
		designService.verifyDesignSubmit(account, orderId_request, taskId,
				designVal, comment);
	...
	public String getComputeDesignCostList(HttpServletRequest request,
		...
		List<Map<String, Object>> list = designService
				.getComputeDesignCostList();
	...
	public String getComputeDesignCostDetail(HttpServletRequest request,
		...
		Map<String, Object> orderInfo = designService
				.getComputeDesignCostDetail(Integer.parseInt(orderId));
		model.addAttribute("orderInfo", orderInfo);
	...
	public String computeDesignCostSubmit(HttpServletRequest request,
		...
		designService.computeDesignCostSubmit(Integer.parseInt(orderId),
				Long.parseLong(taskId), Float.parseFloat(design_cost));

		return "redirect:/design/getComputeDesignCostList.do";
	}

	/**
	 * uploadDesign 录入版型数据跳转链接
	 * 
	 * @author WangJian
	 * @param request
	 * @param response
	...
	/**
	 * CONFIRM DESIGN 设计部生产版型CAD验证跳转链接
	 * 
	 * @author WangJian
	 * @param request
	 * @param response
