...
<link rel="stylesheet" href="${ctx }/css/style.shinyblue.css" type="text/css" />

<script type="text/javascript" src="${ctx }/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="${ctx }/js/jquery-migrate-1.1.1.min.js"></script>
...
<div class="loginpanel">
    <div class="loginpanelinner">
        <div class="logo animate0 bounceIn" style="font-size:35px;color:white;"><!-- <img src="images/logo.png" alt="" /> -->智造链</div>
