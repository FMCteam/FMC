...
<div class="maincontent">
	<div class="maincontentinner">
		<div class="row-fluid" style="min-height:300px;">
			...
			<caption>
						<span class="text-vertical">审核报价列表:<span class="number">${fn:length(quote_list)}</span>件任务
				...
				<tbody>
					...
					<c:forEach var="quoteModel" items="${quote_list}">
						...
						<td> 
                       <a href="${ctx}/market/verifyQuoteDetail.do?orderId=${quoteModel.quote.orderId }&taskId=${quoteModel.task.id }">审核</a></td>
						</tr>
