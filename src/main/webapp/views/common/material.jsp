...
<table class="table table-striped table-bordered table-hover detail">
	<tr>
		<td class="span2" rowspan="${fn:length(orderInfo.fabrics)+1}">面料</td>
		<td class="span5" colspan="4">面料名称</td>
		<td class="span5" colspan="4">面料克重</td>
	</tr>
	...
	<tr>
		...
		<td colspan="4">辅料名称</td>
		<td colspan="4">辅料要求</td>
	</tr>
