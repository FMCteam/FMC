...
<div class="maincontent">
	<div class="maincontentinner">
		<div class="row-fluid" style="min-height:300px;">
            ...
            <table class="list">
                <caption>
					<span class="text-vertical">录入版型数据列表:<span class="number">${fn:length(list)}</span>件任务
					...
					<thead>
	                    ...
	                    <c:forEach var="orderModel" items="${list}" >
	                        <tr class="gradeA">
								...
								<td><a href="${ctx }/design/getUploadDesignDetail.do?orderId=${orderModel.order.orderId}&task_id=${orderModel.task.id}">详情
									</a></td>
	                        </tr>
                        </c:forEach>
                </table>
