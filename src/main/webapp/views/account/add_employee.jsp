                    ...
                    <div class="widget">
			            ...
			            <div class="widgetcontent">
				            <form class="stdform" action="${ctx }/employee/doAdd.do" method="post">
					            ...
					            <p>
		                            <label>姓名</label>
		                            <span class="field"><input type="text" name="employee_name" class="input-large" placeholder="姓名" />&nbsp;<span style="color:#ff0000;">*</span>(必填)</span>
	                        	</p>
	                        	<p>
		                            <label>性别</label>
		                            <span class="formwrapper">
		                            	...
		                            	<input type="radio" name="radiofield" value="3"/> 保密 &nbsp; &nbsp;<span style=" color:#ff0000;">*</span>(必填)
		                            </span>
                        		</p>
                        		<p>
		                            <label>部门</label>
		                            <span class="field"><input type="text" name="department" class="input-large" placeholder="部门" />&nbsp;<span style="color:#ff0000;">*</span>(必填)</span>
	                        	</p>
                        		<p>
		                            <label>年龄</label>
		                            <span class="field"><input type="text" id="spinner" name="employee_age" class="input-small input-spinner" />&nbsp;<span style="color:#ff0000;">*</span>(必填)</span>
		                        </p>
		                        <p>
		                            <label>身份证号码</label>
		                            <span class="field"><input type="text" name="id_card" class="input-large" placeholder="身份证号码" />&nbsp;<span style="color:#ff0000;">*</span>(必填)</span>
	                        	</p>
		                        <p>
		                            <label>角色</label>
		                            <span class="field">
		                            ...
		                            &nbsp;<span style="color:#ff0000;">*</span>(必填)</span>
		                        </p>
		                        <div class="par">
		                            <label>入职时间</label>
		                            <span class="field"><input id="datepicker" type="text" name="in_date" class="input-small" />&nbsp;<span style="color:#ff0000;">*</span>(必填)</span>
		                        </div>
		                        <p>
		                            <label>直接领导</label>
