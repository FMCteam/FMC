                ...
                <table id="dyntable" class="table table-bordered responsive">
					...
					<c:forEach var="orderModel" items="${order_list}">
						<tr class="gradeA">
							...
							<td><form action="${ctx }/finance/confirmSampleMoneyDetail.do" style="display:inline"
									method="post">
							...
							<td><form action="${ctx }/finance/confirmSampleMoneySubmit.do" style="display:inline" method="post">
									<input type="hidden" name="order_id" value="${orderModel.order.orderId }" /> 
									<input type="hidden" name="task_id" value="${orderModel.taskId }" /> 
									<input type="hidden" name="process_id" value="${orderModel.processInstanceId }" />
									<input type="hidden" name="receivedsamplejin" value = "false" />
