			...
			<div class="widget">
				...
				<div class="widgetcontent">
					<table class="table table-striped table-bordered table-hover">
						...
						<tr>
							<td>操作</td>
							<td colspan="6"><a class="btn btn-primary btn-rounded"
								href="${ctx}/logistics/receiveSampleSubmit.do?result=1&taskId=${task.task.id}"><i
									class="icon-ok icon-white"></i>收到样衣</a> <a
								class="btn btn-primary btn-rounded"
								href="${ctx}/logistics/receiveSampleSubmit.do?result=2&taskId=${task.task.id}"><i
									class="icon-remove icon-white"></i>未收到样衣</a></td>
						</tr>
					</table>
				</div>
				<!--widgetcontent-->
