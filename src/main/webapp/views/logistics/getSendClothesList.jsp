                    ...
                    <tbody>
	                    <c:forEach var="orderModel" items="${list}" >
	                        <tr class="gradeA">
								...
								<td><form action="${ctx }/logistics/getSendClothesDetail.do" method="post" >
									<input type="hidden" name="id" value="${orderModel.order.orderId }" />
										...
										<button class="btn btn-primary btn-rounded"><i class="icon-white"></i> 发货</button></form>
								</td>
	                        </tr>
                        </c:forEach>
                    </tbody>
