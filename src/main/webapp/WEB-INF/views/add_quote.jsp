...
<head>
    ...
    <link rel="stylesheet" href="css/add_quote.css">
...
<div class="header">
    <div class="logo"> <a href="#" style="color:white;font-size:55px;font-family:"Miscrosoft YaHei""><!-- <img src="images/logo.png" alt="" /> -->智造链</a> </div>
    <div class="headerinner">
        <ul class="headmenu">
            <li class="odd"> <a href="#"> <span class="count">4</span> <span class="head-icon head-message"></span> <span class="headmenu-label">新任务</span> </a> </li>
            <li> <a> <span class="count">10</span> <span class="head-icon head-users"></span> <span class="headmenu-label">新客户</span> </a> </li>
            <li class="right">
...
<div class="rightpanel">
    ...
    <div class="maincontent">
        <div class="maincontentinner">
            <div class="row-fluid" style="min-height:300px;"> 这里是公司介绍等。
                <!--  如果是其它页面，这里是填充具体的内容。 -->
                ...
                <table class=" table table-striped table-bordered">
                    ...
                    <tr>
                        <td><input class="span12" type="text" disabled="true"/></td>
                        <td><input class="span12" type="text"disabled="true" /></td>
                        <td><input class="span12" type="text" disabled="true"/></td>
                        <td><input class="span12" type="text" disabled="true"/></td>
                    </tr>
