CREATE DATABASE  IF NOT EXISTS `fmc_test` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `fmc_test`;
...
CREATE TABLE `logistics` (
  ...
  `sample_clothes_number` varchar(250) DEFAULT NULL COMMENT '样衣邮寄单号',
...
-- Dump completed on 2014-03-03 17:19:09
