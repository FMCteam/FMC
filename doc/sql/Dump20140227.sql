...
CREATE TABLE `account` (
  ...
  `user_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '用户类型，0表示employee，1表示客户。',
  `user_password` varchar(250) NOT NULL COMMENT '用户密码，加密后存储。',
  `user_name` varchar(250) NOT NULL COMMENT '用户姓名，冗余字段。对应customer_name和employee_name',
...
CREATE TABLE `package` (
  ...
  `order_id` int(11) NOT NULL,
  `package_time` datetime DEFAULT NULL COMMENT '装包日期',
...
-- Dump completed on 2014-02-27 14:54:34
